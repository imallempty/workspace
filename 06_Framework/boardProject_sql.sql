...
CREATE TABLE "MEMBER"(
	...
	"MEMEBER_NICKNAME" NVARCHAR2(10)NOT NULL,
...
COMMENT ON COLUMN "MEMBER"."MEMEBER_NICKNAME" IS '별명';
...
-- 샘플 계정 추가
INSERT INTO "MEMBER"
VALUES(SEQ_MEMBER_NO.NEXTVAL, 'membe01@naver.com', 'pass01', '회원1','01012345678',
...
-- 로그인
SELECT MEMBER_NO, MEMBER_EMAIL, MEMEBER_NICKNAME, MEMBER_TEL, MEMBER_ADDRESS,
		PROFILE_IMG, AUTHORITY, 
		TO_CHAR(ENROLL_DATE, 'YYYY"년" MM"월" DD"일" HH24"시" MI"분" SS"초"') AS ENROLL_DATE 
FROM "MEMBER"
WHERE MEMBER_DEL_FL = 'N'
AND MEMBER_EMAIL = 'membe01@naver.com'
