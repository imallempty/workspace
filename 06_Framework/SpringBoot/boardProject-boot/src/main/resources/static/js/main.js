...
// 쿠키에 saveId가 있을 경우 이메일 input태그에 value로 추가 
...
if (memberEmail != null && saveId != null) {
  ...
  if (email != undefined) { // "saveId"가 있을 경우
...
if (loginFrm != null) {
  ...
  loginFrm.addEventListener("submit", e => {
    ...
    if (memberEmail.value.trim().length == 0) {
      ...
      // sumbit 이벤트 발생 시 form 태그의 기본 이벤트(제출) 제거
      e.preventDefault();
      return;
    }
