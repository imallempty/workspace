...
-- UPDATE 수행 후 위에 SELECT 다시 수행 --> 결과 확인 후 ROLLBACK
...
SELECT * FROM EMP_M01; 
SELECT * FROM EMP_M02; -- EMP_M01과 겹치는 행 4G행, 겹치지 않는 행 1행

UPDATE EMP_M02 SET SALARY = 0; -- EMP_M02DML SALARY를 모두 0으로 수정
