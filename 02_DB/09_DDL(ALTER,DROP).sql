...
CONSTRAINT DEPT_COPY_PK PRIMARY KEY(DEPT_ID);
...
DEPT_ID CONSTRAINT  SYS_C0014129 NULL; -- DEPT_ID NOT NULL 제거

ALTER TABLE DEPT_COPY MODIFY
LOACTION_ID CONSTRAINT SYS_C0014135 NULL;

ALTER TABLE DEPT_COPY MODIFY
DEPT_TITLE CONSTRAINT SYS_C0014135 NULL;
