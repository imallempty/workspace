 ...
 * 
 * 2) "COMMENT" -> COMMENT 테이블명 작성 시 " "로 꼭 감싸기
 *
 */
...
CREATE TABLE MEMBER(
	...
	MEMBER_DEL_FL CHAR(1) DEFAULT 'N' NOT NULL CHECK(MEMBER_DEL_FL IN ('N','Y'))
);
...
CREATE TABLE BOARD(
	...
	CONSTRAINT BOARD_DEL_FL_CH CHECK(BOARD_DEL_FL IN('N','Y'))
);
...
CREATE TABLE "COMMENT"(
	...
	COMMENT_DEL_FL CHAR(1) DEFAULT 'N' NOT NULL CHECK(COMMENT_DEL_FL IN('N','Y')),
