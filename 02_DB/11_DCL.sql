...
--> 관리자 계정으로 접속 할 때 마다 수행

-- 계정 생성
CREATE USER a230830_jdb IDENTIFIED BY "test1234";
--> 생성 후 db 접속 방법 추가
---> 접속 권한 없음

/* 접속 권한 부여(GRANT) */
GRANT CREATE SESSION TO a230830_jdb;
...
------ [관리자 계정 접속] ------
-- 테이블 생성 권한, TABLESAPCE 할당
GRANT CREATE TABLE TO a230830_jdb;

ALTER USER a230830_jdb DEFAULT TABLESPACE "A230724"
...
GRANT CONNECT, RESOURCE, CREATE VIEW TO a230830_jdb;

-- 테스트 사용자 계정 접속 권한 회수해보기
REVOKE CONNECT FROM a230830_jdb;
