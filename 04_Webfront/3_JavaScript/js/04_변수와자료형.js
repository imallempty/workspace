// script 태그 또는 js 파일에 함수 내부가 아닌 위치에
// 코드를 작성하면 HTML 랜더링 시 바로 수행


// 전역 변수
var srt = "html 랜더링 시 바로 실행";
console.log("str");
...
function typeTest() {
  ...
  const phone = '01012345678'; // string
  print(name);
  print(gender);
  print(phone);
