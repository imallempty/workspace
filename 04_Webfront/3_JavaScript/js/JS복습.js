...
function checkBingo() {
  ...
  for (let i = 0; i < rows.length; i++) {
    // rows.[i].children : 각 행의 모든 열(자식 요소)를 배열로 반환
  ...
  for (let i = 0; i < board.length; i++) {
    for (let k = o; k < board[i].length; k++) {
