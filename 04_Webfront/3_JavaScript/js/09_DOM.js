...
document.getElementById("btn1").addEventListener("click", () => {
  ...
  // ----------------------------------------------------------------
  // 원하는 위치(인덱스)에 존재하는 자식 노드 탐색
  //   : childNodes[인덱스]

  // #test의 자식 노드 리스트(list)에서 9번 인덱스 노드 얻어오기
  console.log(list[9]);
  list[9].style.backgroundColor = "plum";
...
const divn3 = document.getElementById("div3");

btn3.addEventListener("click",()=> {
  divn3.innerHTML += '<input type="text">';
});

// ----------------------------------------------------------------
/* document.createElement()로 생성하기 */
const btn4 = document.getElementById("btn4");
const div4 = document.getElementById("div4");

btn4.addEventListener("click",() => {
  
  // 1) input 요소 생성 -> 생성만 된 것이지 배치되지 않은 상태
