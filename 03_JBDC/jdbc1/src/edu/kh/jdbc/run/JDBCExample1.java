...
public class JDBCExample1 {
	public static void main(String[] args) {
		...
		// JDBC : Java에서 DB에 접근할 수 있게 해주는 Java 제공 코드(interface, class)
		//			-> java.sql 패키지에 존재
...
//			executeUpdate() : DML(INSERT, UPDATE, DELETET)을 수행하고 결과 행의 수(int)를 반환
			...
			while(rs.next()) {
				...
				// 지정된 컬럼의 값을 Java 자료형을 변환해서 얻어오기
			...
			// ClassNotFoundException : Oracle JDBC Driver 없을 때 발생
			// -> 경로 오타 또는 라이브러리 추가 X
			e.printStackTrace();
