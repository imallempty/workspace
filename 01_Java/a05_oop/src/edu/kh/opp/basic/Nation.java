...
public class Nation {
	...
	public void introduce() { // 자기 소개 기능
		System.out.printf("저의 이름은 %s이고, 직업은 %s 입니다. \n",name, job);
	}
	
	
	// 캡슐화 원칙에 의해서 직접 접근이 차단된 변수(필드)에 값을 세팅하거나 얻어갈 수 있는 간접 접근 기능을 작성
	
	// 전달 받은 값으로 job을 세팅하는 기능
	public void setJob(String job) { // String job(매개변수) 전달된 값을 저장하는 변수
		this.job =job;
	}
