 ...
 * 
 * - JAVA : 클래스에 작성된 내용을 토대로 new 연산자에 의해 Heap 메모리에 생성되는것
 * 
 * 클래스(class)란?
...
public class BasicRun {
	...
	public static void main(String[] args) {
		...
		// new Nation() : Nation 클래스를 이용해서 Heap 영역에 Nation 객체를 생성 (메모리 할당)
		// 				-> 할당된 메모리의 시작 주소가 반환됨
		
		// Nation n1 = new Nation();
		// Nation 참조 변수 n1에 Heap에 새로 생성된 Nation객체의 주소를 대입
