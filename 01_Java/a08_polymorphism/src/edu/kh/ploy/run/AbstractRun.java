...
import edu.kh.ploy.model.dto.Animal;
import edu.kh.ploy.model.dto.Fish;
import edu.kh.ploy.model.dto.Person;
...
//		Animal a = new Animal();
		...
		a1.breath();
		// 동적 바인딩의 성질을 이용하여
		// 추상 메서드인 Animal.breath() 호출되는 경우가 없게 만듦
