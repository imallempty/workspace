...
public class ExceptionService {
	...
	public void ex1() {
		...
		try {
			String input = br.readLine(); // 한 줄 읽어오기기
...
//			It is already handled by the catch block for RuntimeException
			...
			// InputMismatchException도 먼저 잡아서 처리하기 대문ㅇ
	...
	public void ex5() {
		...
		try {
			switch(input) {
			case 1 : System.out.println("<정상동작>"); break; 
	...
	public void ex7() {
		...
		//         (책임 전가)
		// 장점 : 한 곳의 예외를 몰아서 처리 가능 (코드 길이 감소)
		try {
			methodA();
