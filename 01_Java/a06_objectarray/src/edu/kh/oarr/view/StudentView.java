...
public class StudentView {
	...
	private String addStudent() {
		...
		public void updateStudent() {
			...
			// 	  존재하는 학생이면 학생 객체 주소, 아니면 null 반환 받기
			...
			Student s = service.selectIndex(index);
			// 이미 존재하는 service selectIndex(index) 메서드 이용
		...
		public void selectMaxMin() {
			System.out.println("-----평균 최고점, 최저점 학생 찾기-----");
			
			// 최고점 : 1학년 2반 3번 홍길동 
			// 국어:100 / 수학:100 / 영어:100 / 평균:100.0
			
			// 최점점 : 3학년 2반 5번 최미영 
			// 국어:50 / 수학:40 / 영어:40 / 평균:40.0
			...
			System.out.printf("최고점 : %d학년 %d반 %d번 %s \n "
					+ "국어:%d / 수학:%d / 영어:%d / 평균:%.1f \n", arr[1].getGrade(), arr[1].getBan(),arr[1].getNumber(),
					arr[1].getName(), arr[1].getKor(), arr[1].getEng(), arr[1].getMath(), 
