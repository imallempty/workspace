...
public class VariableEx8 {
	...
	public static void main(String[] args) {
		 ...
		 * 	 <컴파일러(번역기)>가 자동으로 [값의 범위]가 작은 자료형을 큰 자료형으로 변경
		 */
		...
		char ch1 = 'A'; // 문자가 A가 저장되는게 아니라 유니코드 표에서  A에 대응되는 값 65가 저장됨
		...
		// 실수 -> 정수 강제 형변환 시 소수점 아래 버림 처리 (데이터 손실)
		...
		double test5 = 3.1234567890123456789;
