...
public class VariableEx2 {
	...
	public static void main(String[] args) {
		...
		//1byte를 메모리에 할당하고 그 공간을 isTure라고 부르겠다.
		
		int number1;
		//정수형 데이러를 저장할 공간
		// 4byte를 메모리에 할당하고 그 공간을 number1라고 부르겠다
		
		double number2;
		// 실수형 데이터를 저장할 공간
		// 8byte를 메모리에 할당하고 그 공간을 number2라고 부르겠다.
		...
		isTrue = true; // boolean형 변수에 ture 대입
		// boolena 리터럴 표기법: true/false
