...
public class ConditionEx {
	...
	public void ex4() {
		...
		if(month >= 3 && month <= 5) { // 봄(3월, 4월 5월)
			season = "봄";
		} 
		
		else if (month >= 6 && month <= 8) { // 여름(6월, 7월, 8월)
			season = "여름";
		} 
		
		else if (month >=9 && month <= 11) { // 가을 (9월, 10월, 11월)
			season = "가을";
		} 
		
		else if (month == 12 || month == 1 || month == 2) {// 겨울(12월, 1월, 2월)
			season = "겨울";
		} 
