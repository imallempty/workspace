...
public class MapEx {
	...
	public void ex1() {
		...
		// Value가 String이니깐 String 변수에 저장
		String s = map.get(1); 
		...
		// 6. boolean map.isEmpty() : 비었으면 true, 아님 faluse
	...
	public void ex2() {
		...
		// 2. keySet을 이용해서 Map에 있는 모든 요소 순차 접금
		System.out.println("-----------------------------");
		for(String key : set) {
