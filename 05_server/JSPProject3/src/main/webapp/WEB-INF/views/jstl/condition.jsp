...
<body>
  ...
  <c:set var="menu" scope="page" value="햄버거"/>
  <c:set var="price" scope="page" value="19000"/>
  ...
  <pre>
    ...
    *** c:choose 태그 작성 주의 사항 ***
    choose 태그 내부에는 c:when, c:otherwise, JSP 주석, 공백 이외에는 아무것도 작성되면 안된다!

    - c:when(언제) 태그 : if, else if를 나타내는 태그, 속성은 test 밖에 없음(c:if 참고)
