...
<body>
  ...
  <pre>
    Servlet/JSP에는 4종류 범위를 타나낸 내장 객체가 존재한다!
  ...
  <h1>우선 순위 확인</h1>
  <% //page scope
    pageContext.setAttribute("str", "application scope에 세팅된 문자열");
  %>

  <h2>\${key} : 4종류의 scope 객체를 좁은 순서대로 탐색해서 key가 일치하는 속성이 존재하면 출력</h2>

  <h2>${str}</h2>

  <hr>

  <h2>\${XXXScope.key} : XXX 자리에 scope를 작성하면 해당 scope에서 key가 일치하는 속성을 찾아 출력</h2>
