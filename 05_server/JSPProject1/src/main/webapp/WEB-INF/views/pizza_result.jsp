...
<%-- 
  ...
  uri(Uniform Resource Identifier, 통합 자원 식별자) : 
    ...
    -> ID 같은 것 (JSTL 라이브러리에서 원하는 코드 찾기)
 --%>
...
<body>
  ...
  <pre>
    ...
    \${KEY} 형식으로 작성하면 KEY에 해당하는 Value가 화면에 표시됨
  </pre>
  ...
  <pre>
    JSP에서 자주 사용되거나, 공통적으로 사용되는 Java 코드(if, for, 변수 선언, 형변환 등)를
    JSP에서 작성하기 편하게 태그 형식으로 만들어 표준으로 제공하는 라이브러리
    (만들어진 태그 == 커스텀 태그)
  </pre>
